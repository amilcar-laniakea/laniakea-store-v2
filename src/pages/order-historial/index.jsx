...
const OrderHistorial = () => {
  ...
  if (error) return <Error error={"ha ocurrido un error en la consulta."} />;
    ...
    <>
      ...
      <div className="global-container">
        <div className="main-container">
          ...
          {data.length === 0 ? (
            <Error error={"No se encontraron ordenes."} />
          ) : (
            <>
              {data.map((item, index) => (
                <div key={index} className="order-historial-list-container">
                  ...
                  {item.cart_items.map((element, i) => (
                    <div
                      key={i}
                      className="order-historial-list-cart-container"
                    >
                      <Row>
                        <Col xs={24} sm={24} md={24} lg={5} xl={5}>
                          <Image
                            container={
                              "order-historial-list-cart-image-container"
                            }
